function [p_risky_t, p_high_t, Qall, UCB_all] = sim_UCB_spread_riskPref(params, dist, nIters)
...
choiceType   = NaN(nIters, 120);
    ...
    for i = 1: nIters
        ...
        for t = 1: 120-1
            ...
            % spread (S) around Q 
            UCB_v = (params.c *(sqrt(2*log(t)./St)));
            ...
            St(stimIdx) = St(stimIdx) + (params.alpha*delta_s);
