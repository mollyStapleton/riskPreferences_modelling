...
%     for itype = 1:2
%         if idist == 1
%             avgParam_alpha = 0.2948;
%             avgParam_beta  = 0.6691;
%             if itype == 1
%                 axes(h1);
%                 axis square
%             else
...
%             end
%         else
%             avgParam_alpha = 0.1972;
%             avgParam_beta  = 0.8215;
%             if itype == 1
%                 axes(h3);
%                 axis square
%             else
...
cd('C:\Users\jf22662\OneDrive - University of Bristol\Documents\GitHub\modelling_figures\parameter_simulations\RW')
% saveFigname = ['riskPreferences'];
