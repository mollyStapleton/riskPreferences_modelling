function  [p_risky_t, p_high_t, Qall, UCB_all] = sim_UCB_nCount_riskPref(params, dist, nIters)
    ...
    for i = 1: nIters
        ...
        UCB_v      = [0 0 0 0]; %assuming each arm has already been sampled once
        p          = NaN(1, 120);
        Qtrack     = NaN(120, 4);
        UCB_track  = NaN(120, 4);
        ...
        for t = 1: 120-1
            ...
            UCB_v = (params.c *(sqrt(2*log(t))./stimCount));
